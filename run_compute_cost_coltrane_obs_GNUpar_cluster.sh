...
folder_name_store_outputs="costs_sim2"
...
python -u merge_pickle_files.py "$folder_path_calibration$folder_name_store_outputs" "$folder_path_calibration" "merged_costs_files_2013data_u0fix_IA_8000sets.pkl"
