...
def select_C6_august_repro(popts, pop):
    """
    Select individuals of stage C6 in August that reproduced (i.e., tEcen not nan)
    ...
    2 --> individuals that reproduced and were C6 in august
    ...
    for i in range(0,popts['D'].shape[2]):
        C5_august[august,:,i] = np.where(popts['stage'][august,:,i] == 13, 1, 0)
