...
if __name__ == '__main__':
    ...
    # To test
    #run_calibration(0.39392328334701276, 0.8498392303370423, 0.7962040794882776, 0.16201464653836029, 90, 250,"C. glacialis", 0.007, "./", "merged_LOKI2013_ecotaxa_masks_features_for_calibration.csv")
